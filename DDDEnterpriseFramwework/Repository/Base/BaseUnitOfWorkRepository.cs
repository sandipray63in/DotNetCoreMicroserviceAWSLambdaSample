...
namespace Repository.Base
{
    ...
    public abstract class BaseUnitOfWorkRepository<TEntity>
        where TEntity : ICommandAggregateRoot
    {
        ...
        internal abstract Task ActualInsertAsync(TEntity item, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        internal abstract Task ActualUpdateAsync(TEntity item, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        internal abstract Task ActualDeleteAsync(TEntity item, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        internal abstract Task ActualInsertAsync(IEnumerable<TEntity> itemsEnumerable, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        internal abstract Task ActualUpdateAsync(IEnumerable<TEntity> itemsEnumerable, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        internal abstract Task ActualDeleteAsync(IEnumerable<TEntity> itemsEnumerable, CancellationToken token = default, Action operationToExecuteBeforeNextOperation = null);
        #endregion
    }
}